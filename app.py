...
# branches = st.multiselect('Отрасли:', default_select, default_select)
# years = st.slider('За период:', min_value=2000, max_value=2023, value=(2000, 2023))
# show_infl = st.checkbox('С учетом накопленной инфляции', value=True)
